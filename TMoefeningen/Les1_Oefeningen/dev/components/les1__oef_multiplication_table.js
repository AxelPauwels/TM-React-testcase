...
const Header = (props) => {
    let charInTextFormat = ["Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine"];
    let numberInText = charInTextFormat[props.number];
    let headerStyle = {
        fontSize: 50,
        color: "#e65100",
    ...
    return (
        <thead>
        <tr>
            <th style={headerStyle}>{numberInText}</th>
        </tr>
        </thead>
    );
};
