...
const Slider = (props) => {
    return (
        <input type="range" value={props.waarde} min={props.min} max={props.max}
...
class BmiCalculator extends Component {
    constructor(props) {
        ...
        this.state = {heightWaarde: 178, weightWaarde: 80, bmiWaarde: 23};
    ...
    render() {
        ...
        return (
            <div style={calculatorStyle.container}>
                <div style={calculatorStyle.label}>BMI Calculator</div>
                <br/>
                <BmiSlider soortSlider="Height" onChangeSlider={this.onChange_handler}
                           min="0" max="200" waarde={this.state.heightWaarde}/>
                <BmiSlider soortSlider="Weight" onChangeSlider={this.onChange_handler}
                           min="0" max="200" waarde={this.state.weightWaarde}/>
                <BmiSlider soortSlider="BMI" onChangeSlider={this.onChange_handler}
                           min="0" max="100" waarde={this.state.bmiWaarde}/>
            </div>
        );
    }
}
